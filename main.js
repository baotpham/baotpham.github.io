...
var ReviewPageComponent = /** @class */ (function () {
    ...
    ReviewPageComponent.prototype.postToGoogle = function () {
        ...
        this.googleService.post(this.registers, this.new_cost).then(function () { _this.loading = false; }, function () { _this.loading = false; });
    };
...
var GoogleService = /** @class */ (function () {
    ...
    GoogleService.prototype.post = function (registers, cost) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
